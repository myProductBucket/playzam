...
/**
 * Created by Sid on 8/4/2015.
 */
public class TrendListAdapter extends BaseAdapter {
    private Activity activity;
    private LayoutInflater inflater;
    private List<SearchHelper> searchItems;
    TrendFragment buttonListener;
    ImageLoader imageLoader = AppController.getInstance().getImageLoader();

    public TrendListAdapter(Activity activity, List<SearchHelper> songItems,TrendFragment buttonListener) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        playlistBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonListener.addToPlaylistClick(searchItems,position);
            }
        });
